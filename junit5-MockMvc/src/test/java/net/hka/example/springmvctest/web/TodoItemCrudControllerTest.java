/*
 * https://www.petrikainulainen.net/programming/testing/writing-unit-tests-for-normal-spring-mvc-controllers-configuration/
 */
package net.hka.example.springmvctest.web;

import static net.hka.example.springmvctest.web.WebTestConfig.exceptionResolver;
import static net.hka.example.springmvctest.web.WebTestConfig.fixedLocaleResolver;
...
import net.hka.example.springmvctest.todo.TagDTO;
import net.hka.example.springmvctest.todo.TodoItemCrudService;
import net.hka.example.springmvctest.todo.TodoItemDTO;
import net.hka.example.springmvctest.todo.TodoItemNotFoundException;
import net.hka.example.springmvctest.todo.TodoItemStatus;
